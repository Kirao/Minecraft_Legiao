...
const CREATORS_DATA: Creator[] = [
  ...
  { id: '29', name: 'Forever', imageUrl: youtubeAvatar('ForeverPlayer'  ), youtubeUrl: 'https://www.youtube.com/@ForeverPlayer', twitchUrl: 'https://www.twitch.tv/forever' },
  { id: '30', name: 'YayahGatinha', imageUrl: youtubeAvatar('yayahgatinha'  ), twitchUrl: 'https://www.twitch.tv/yayahgatinha' },
];
